...
_PROVIDER_CONTRACTS = {
    "wechat_kf": ChannelProviderContract(
        ...
        verification_contract={
            "production_status": "official_text_message_round_trip_ready",
            ...
            "notes": "支持 URL 验证、AES 解密、kf_msg_or_event 消息同步、统一 AI/转人工处理和官方文本外发；open_kfid 可由配置填写或在首次同步消息后自动补齐。",
        },
        inbound_event_contract={
            "raw_payload_retained": True,
            "signature_values_stored": False,
            "parsed_event_status": "wechat_kf_messages_synced_after_signature_and_decrypt_validation",
